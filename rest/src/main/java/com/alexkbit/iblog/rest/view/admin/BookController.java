...
public class BookController {
    ...
    public ModelAndView get() {
        return new ModelAndView("admin/book", "book", new Book());
    }

    @RequestMapping(value = "/book/image", method = RequestMethod.POST)
    public ModelAndView uploadingPost(Book book, @RequestParam("uploadingFiles") MultipartFile uploadingFile,
        ...
        book.setImage(image);
        return new ModelAndView("admin/book", "book", book);
    }

    @RequestMapping(value = "/book", method = RequestMethod.POST)
    public ModelAndView bookPost(Book book, Authentication authentication) {
